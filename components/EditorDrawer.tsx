...
const EditorDrawer: React.FC<EditorDrawerProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* DEVICE AND ORIENTATION SECTION - ALWAYS VISIBLE */}
      <div className="px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 border-b-2 border-blue-400 dark:border-blue-600 space-y-3 flex-shrink-0">
        <div className="text-[9px] font-black text-blue-700 dark:text-blue-300 uppercase tracking-widest">📱 Device Preview</div>

        {/* DEVICE SELECTOR */}
        <div>
          <div className="text-[9px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider mb-2">Device</div>
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded text-[10px] font-bold uppercase transition-all ${
                teamEditDevice === 'mobile'
                  ...
                  : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-blue-300 dark:border-blue-600 hover:bg-blue-50 dark:hover:bg-gray-600'
              }`}
            >
        ...
        <div>
          <div className="text-[9px] font-bold text-green-600 dark:text-green-400 uppercase tracking-wider mb-2">Orientation</div>
          <div className="flex gap-2">
            <button
              onClick={() => onTeamEditOrientationChange?.('portrait')}
              className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded text-[10px] font-bold uppercase transition-all ${
                teamEditOrientation === 'portrait'
                  ? 'bg-green-600 text-white border border-green-400 shadow-lg'
                  : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-green-300 dark:border-green-600 hover:bg-green-50 dark:hover:bg-gray-600'
              }`}
            >
              <span>⬜</span>
              Port
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 py-2 px-3 rounded text-[10px] font-bold uppercase transition-all ${
            teamEditOrientationLocked
              ? 'bg-orange-600 text-white border border-orange-400 shadow-lg'
              : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-orange-300 dark:border-orange-600 hover:bg-orange-50 dark:hover:bg-gray-600'
          }`}
        >
          {teamEditOrientationLocked ? (
            <>
      ...
      {!activeGame ? (
          ...
          <>
            {/* PLAYGROUND SECTION STARTS HERE */}
            <div>
