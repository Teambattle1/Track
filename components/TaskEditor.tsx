...
const TaskEditor: React.FC<TaskEditorProps> = ({ point, onSave, onDelete, onClose, onClone, isTemplateMode = false }) => {
  ...
  const renderContentTab = () => (
    <div className="space-y-5">
        {/* Title */}
        <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Internal Title</label>
            <input 
                type="text" 
        ...
        {/* Short Intro */}
        <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Short Intro (Mouseover)</label>
            <input 
                type="text" 
        ...
        {/* Task Question (RTF) */}
        <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Task Description / Question</label>
            <RichTextEditor 
        ...
        {/* Task Type Selector */}
        <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Answer Type</label>
    ...
    <div className="space-y-6">
        ...
        <div>
            <div className="flex justify-between mb-1">
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300">Image (Optional)</label>
            </div>
            ...
            <div className="flex gap-2 mb-2">
                <button 
                    ...
                    className="flex-1 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 px-3 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-colors"
                >
                ...
                <button 
                    ...
                    className="flex-1 bg-gradient-to-r from-orange-500 to-pink-500 text-white px-3 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 shadow-sm hover:opacity-90 transition-opacity disabled:opacity-50"
                >
            ...
            {editedPoint.task.imageUrl && (
                <button type="button" onClick={() => setEditedPoint({...editedPoint, task: {...editedPoint.task, imageUrl: undefined}})} className="text-xs text-red-500 mt-2 flex items-center gap-1 hover:underline">
        ...
        {/* Video */}
        <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">YouTube or Vimeo Link</label>
        ...
        {/* Audio */}
        <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Audio Clip</label>
  ...
  const renderActivationTab = () => (
      <div className="space-y-6">
          {/* Methods */}
          <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">Activation Methods</label>
              <div className="space-y-3">
                  <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 cursor-pointer">
                      ...
                      <div className="flex-1">
                          <span className="font-bold text-gray-800 dark:text-white block">GPS Radius</span>
                      ...
                      <div className="w-24">
                          ...
                          />
                          <span className="text-[10px] text-gray-400 text-right block">meters</span>
                      </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 cursor-pointer">
                      ...
                      />
                      <div>
                          <span className="font-bold text-gray-800 dark:text-white block">Open on Click</span>
                  ...
                  <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 cursor-pointer">
                      ...
                      />
                      <div className="flex-1">
                          <span className="font-bold text-gray-800 dark:text-white block">Barcodes / QR</span>
  ...
  const renderSettingsTab = () => (
      <div className="space-y-5">
           {/* Points */}
          <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Points for Task</label>
              <input 
                type="number" 
          ...
          {/* Time Limit */}
          <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Time Limit (Optional)</label>
          ...
          <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">Score depends on answering speed</span>
          </label>
          ...
          {/* Pin Icon */}
          <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Pin Icon</label>
           ...
           {/* Area Color */}
           <div>
               <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Area Color</label>
               <input 
                  type="text" 
           ...
           {/* Instructor Notes */}
           <div>
               <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Instructor Notes</label>
               <textarea 
  ...
  const renderLogicTab = () => (
      <div className="space-y-6">
          ...
          <div className="space-y-2">
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-300">Completion Events</label>
              {[
          ...
          <div className="space-y-2">
              <label className="flex items-center gap-2">
                  <input 
                    ...
                    className="w-4 h-4 text-orange-600 rounded"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Show if the answer was correct or incorrect</span>
              </label>
              <label className="flex items-center gap-2">
                  <input 
                    type="checkbox" 
                    ...
                    className="w-4 h-4 text-orange-600 rounded"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Show correct answer after user answers incorrectly</span>
              </label>
          </div>
          ...
          {/* Feedback Messages */}
          <div>
              <label className="block text-sm font-bold text-green-600 mb-1">Correct Answer Message</label>
              <div className="flex items-center gap-2 mb-2">
                 ...
                 <span className="text-xs text-gray-500">Show message</span>
              </div>
              <textarea 
          ...
          <div>
              <label className="block text-sm font-bold text-red-600 mb-1">Incorrect Answer Message</label>
              <div className="flex items-center gap-2 mb-2">
          ...
          {/* Hints */}
          <div>
              <label className="block text-sm font-bold text-amber-600 mb-1">Hint</label>
              <textarea 
              ...
              />
              <div className="flex items-center gap-2">
                 <span className="text-sm">Cost to activate:</span>
                 <input 
                    type="number" 
  ...
  const renderTypeConfig = () => {
    ...
    return <p className="text-xs text-gray-500">No specific settings for this type.</p>;
  };
        ...
        {isCropping && pendingImage ? (
           <div className="flex flex-col h-full bg-black p-4">
              ...
              <div className="flex gap-3">
                  <button onClick={() => { setIsCropping(false); setPendingImage(null); }} className="flex-1 py-3 bg-gray-800 text-white rounded-xl font-bold">Cancel</button>
                  ...
                  }} className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold">{isUploading ? 'Saving...' : 'Crop & Save'}</button>
              </div>
           </div>
        ) : (
           <form onSubmit={handleSubmit} className="flex flex-col h-full overflow-hidden">
                       ...
                       <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                           <div className="flex flex-wrap gap-2 mb-3">
                               {editedPoint.tags?.map(tag => (
                                   <span key={tag} className="px-2 py-1 rounded text-xs font-bold text-white flex items-center gap-1" style={{backgroundColor: tagColors[tag] || TAG_COLORS[0]}}>
               ...
               <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex gap-3">
                    ...
                    {onClone && <button type="button" onClick={() => onClone(editedPoint)} className="flex-1 py-3 bg-amber-100 text-amber-700 rounded-xl font-bold hover:bg-amber-200 flex items-center justify-center gap-2"><Copy className="w-4 h-4"/> Clone</button>}
                    <button type="submit" className="flex-[2] py-3 bg-orange-600 text-white rounded-xl font-bold hover:bg-orange-700 flex items-center justify-center gap-2"><Save className="w-4 h-4"/> Save Changes</button>
               </div>
           </form>
        )}
      </div>
