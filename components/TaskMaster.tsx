                        ...
                        >
                            ...
                            <div className="flex items-start gap-2 mb-2 flex-wrap">
                                {!hasValidAnswers(task) && (
                                    <span className="px-2 py-1 rounded text-[9px] font-black bg-red-500/20 text-red-400 border border-red-500/40 flex-shrink-0 flex items-center gap-1 uppercase tracking-widest" title="No correct answer defined">
                            ...
                            <h4
                                ...
                                className="font-bold text-gray-900 dark:text-white text-sm mb-1 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors uppercase line-clamp-2"
                                title="Click to edit"
                            >
                                {task.title}
                            </h4>
