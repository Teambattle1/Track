  ...
  return (
    <div className="fixed inset-0 z-[5000] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in">
      <div className="bg-[#111111] border-2 border-orange-500/20 w-full max-w-lg max-h-[80vh] rounded-[2rem] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,1)] flex flex-col">
        <div className="p-6 border-b border-orange-500/20 flex justify-between items-center bg-black/80 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-white tracking-wider uppercase">TEAM LOBBY</h2>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 rounded-xl bg-orange-600/15 border border-orange-500/30 text-orange-400 hover:bg-orange-600/25 hover:border-orange-500/50 transition-all"
              title="Switch game"
            >
              <ArrowLeftRight className="w-4 h-4" />
              <span className="text-xs font-black uppercase tracking-wider">GAME</span>
            </button>
            <button onClick={() => selectedGameId && loadTeams(selectedGameId)} className="p-2.5 hover:bg-white/10 rounded-xl text-slate-400 hover:text-white transition-colors" title="Refresh">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              <Users className="w-14 h-14 text-slate-500 mb-4" />
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-slate-300 font-bold uppercase tracking-widest mt-0.5">
                    {team.members?.length || 0} MEMBERS · <span className="text-orange-400">{team.score || 0} PTS</span>
                  </p>
                </div>
